...
{
    public static final DeferredRegister<RecipeType<?>> RECIPE_TYPES = DeferredRegister.create(Registry.RECIPE_TYPE_REGISTRY, EverythingCopper.MODID);
...
//    public static final RegistryObject<RecipeSerializer<?>> WEATHERING = RECIPE_SERIALIZERS.register("weathering", () -> new SimpleRecipeSerializer<>(id -> new WeatheringRecipe(id, null, null)));
