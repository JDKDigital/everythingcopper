...
public class ModItems
{
    ...
    public static final DeferredHolder<Item, ? extends Item> COPPER_HELMET = ITEMS.register("copper_helmet", () -> new CopperArmorItem(ModArmorMaterials.COPPER_MATERIAL, ArmorItem.Type.HELMET, (new Item.Properties())));
    public static final DeferredHolder<Item, ? extends Item> COPPER_CHESTPLATE = ITEMS.register("copper_chestplate", () -> new CopperArmorItem(ModArmorMaterials.COPPER_MATERIAL, ArmorItem.Type.CHESTPLATE, (new Item.Properties())));
    public static final DeferredHolder<Item, ? extends Item> COPPER_LEGGINGS = ITEMS.register("copper_leggings", () -> new CopperArmorItem(ModArmorMaterials.COPPER_MATERIAL, ArmorItem.Type.LEGGINGS, (new Item.Properties())));
    public static final DeferredHolder<Item, ? extends Item> COPPER_BOOTS = ITEMS.register("copper_boots", () -> new CopperArmorItem(ModArmorMaterials.COPPER_MATERIAL, ArmorItem.Type.BOOTS, (new Item.Properties())));
