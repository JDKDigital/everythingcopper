...
public class CopperAnvilMenu extends AnvilMenu {
    ...
    protected void onTake(Player player, ItemStack stack) {
        ...
        this.access.execute((level, pos) -> {
            ...
            if (!this.player.getAbilities().instabuild && blockstate.is(BlockTags.ANVIL) && this.player.getRandom().nextFloat() < breakChance) {
                BlockState newBlockState = CopperAnvil.damage(blockstate);
